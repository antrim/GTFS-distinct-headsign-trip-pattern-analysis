...
SELECT string_agg(one_trip::TEXT, ',') as list_trips,timed_patterns.agency_id,timed_patterns.stops_pattern,agency.agency_name,routes.route_short_name,routes.route_long_name,directions.direction_label,trips.direction_id,
...
ORDER BY headsign_combo_count DESC,pattern_id